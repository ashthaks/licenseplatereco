...
pdfreader = PdfReader(r"./vehicle.pdf")
...
def get_response():
    ...
    if user_input.strip().lower() in ["hi","hai", "hello", "hey","hy","hi ruby","hello ruby","hey ruby","hy ruby"]:
        bot_response = "Hello, welcome to Automobile Chatbot. How can I assist you today!"
